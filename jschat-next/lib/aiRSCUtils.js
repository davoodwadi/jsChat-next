...
function InternalAIProvider({
  ...
  return /* @__PURE__ */ jsx(InternalAIStateProvider.Provider, {
    value: aiState,
    children: /* @__PURE__ */ jsx(InternalUIStateProvider.Provider, {
      value: uiState,
      children: /* @__PURE__ */ jsx(InternalActionProvider.Provider, {
        value: clientWrappedActions,
        children: /* @__PURE__ */ jsx(InternalSyncUIStateProvider.Provider, {
...
function useSyncUIState() {
  const syncUIState = React.useContext(InternalSyncUIStateProvider);
  if (syncUIState === null) {
